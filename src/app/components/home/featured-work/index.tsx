                    ...
                    <div className="flex flex-col max-w-3xl mx-auto py-10 px-4 sm:px-7">
                        <div className="flex flex-col xs:flex-row gap-5 items-center justify-between">
                            ...
                            <Button asChild variant={"outline"} className="h-auto">
                                <Link href={"https://drive.google.com/drive/folders/1c-5odIDcuLnoue_g_L1H5EU-A-aVGUVC?usp=sharing"} target="_blank" rel="noopener noreferrer" className="py-3 px-5">
                                    Download Resume
                                </Link>
                            </Button>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 border-t border-primary/10">
                        {featureWork?.map((value: any, index: number) => {
                            ...
                            return (
                                ...
                                >
                                    <Link href={value?.url || "/"} className="overflow-hidden">
                                        <Image
                                            src={value?.image}
                                            alt={value?.title}
                                            width={490}
