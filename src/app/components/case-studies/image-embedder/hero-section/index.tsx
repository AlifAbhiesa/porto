                ...
                <div className="border-x border-primary/10">
                    <div className="flex flex-col gap-6 max-w-3xl mx-auto px-4 sm:px-7 py-10 md:py-16">
                        ...
                        <p className="text-lg text-secondary">
                            Compare two images using MediaPipe Image Embedder to measure visual similarity
                            with cosine similarity scoring — fully processed in your browser.
                        </p>
                    </div>
                </div>
            </div>
