                ...
                <div className="border-x border-primary/10">
                    <div className="flex flex-col gap-6 max-w-3xl mx-auto px-4 sm:px-7 py-10 md:py-16">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <Badge variant="outline" className="py-1.5 px-3 rounded-lg">
                                <span className="text-xs sm:text-sm font-medium text-primary">DevOps</span>
                            </Badge>
                            <Badge variant="outline" className="py-1.5 px-3 rounded-lg">
                                <span className="text-xs sm:text-sm font-medium text-primary">Infrastructure</span>
                            </Badge>
                        </div>
                        ...
                        <p className="text-lg text-secondary">
                            Production-grade services using Docker and Kubernetes with comprehensive
